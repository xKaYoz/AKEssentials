...
public class Files {
    ...
    public void createFile(String name) {
        this.file = new File(Bedwars.getInstance().getDataFolder(), name + ".yml");

        if (!Bedwars.getInstance().getDataFolder().exists()) {
            Bedwars.getInstance().getDataFolder().mkdir();
        }
    ...
    public void createFile(String dir, String name) {
        File f = new File(Bedwars.getInstance().getDataFolder() + File.separator + dir);
    ...
    public File getFile(String dir, String name) {
        this.file = new File(Bedwars.getInstance().getDataFolder() + File.separator + dir, name + ".yml");
    ...
    public File getDir(String dir) {
        this.file = new File(Bedwars.getInstance().getDataFolder() + File.separator + dir);
